// Pas d'import direct depuis "aws-amplify/utils" -> on reste agnostique.
// L'app nous passera l'objet I18n (ayant setLanguage/putVocabularies).
...
export function configAuthI18n(i18n: typeof I18n): void {
    i18n.setLanguage("fr");
    i18n.putVocabularies({ fr: vocabFr });
}
